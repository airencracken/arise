...
defaults to `1.0`. Equivalent-but-slower is a failure. Real milestone workloads
should use higher budgets wherever Arise should have a decisive architectural
advantage. Only harness self-tests may set the budget to zero.
