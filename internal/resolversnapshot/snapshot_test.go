...
func TestRoundTrip(t *testing.T) {
	...
	record := &metadata.PackageMetadata{
		...
		SLOT: "0", KEYWORDS: "amd64", IUSE: "+ssl", RDEPEND: "dev-libs/foo", EAPI: "7", SRC_URI: "https://example/pkg.tar", RESTRICT: "mirror strip",
		EAPIDeprecated: true,
	}
	...
	if len(got) != 1 || got[0].CPV() != "cat/pkg-1.2.3" || got[0].RDEPEND != "dev-libs/foo" || got[0].RESTRICT != "mirror strip" || !got[0].EAPIDeprecated {
